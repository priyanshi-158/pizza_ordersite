...
const Card = ({data}) => {
  return ( 
    <Link to={data._id} key={data._id} className='w-[50%] flex px-2 flex-col lg:px-4 lg:w-[25%] items-center justify-center py-4 lg:py-8 hover:shadow-xl shadow-sm cursor-pointer m-2'>
    <div >
